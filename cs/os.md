...
1. [Operating Systems: From 0 to 1](https://github.com/tuhdo/os01)
1. [Unikernels](http://unikernel.org/)
1. [Redox](https://github.com/redox-os/redox)
1. [Github: Atmanos](https://github.com/atmanos/atmanos)
1. [Writing a kernel using rustboot & rust-core](https://jvns.ca/blog/2013/11/29/writing-an-os-using-rustboot-and-rust-core/)
